 ...
 * @version 1.0.0
 * MIT License
 * Ion jQuery Plugins. Aimed at making JavaScripting much easier.
 */
...
(function ($) {
     ...
     * @method fbind
     */
    $.fbind = function (func, context, append) {
        var outerArgs = $.slice(arguments, 3);
        append = $.isDefined(append) ? append : false;
        return function () {
    ...
    $.decorator = function (instance, methodName, func) {
        ...
        return (instance[methodName] = $.lbind(func, instance, old));
    };
    ...
    $.lbind = function (func, context) {
        return $.fbind.apply(null, ([func, context, false]).concat($.slice(arguments, 2)));
    };
    /**
     * 'Right' bind<br/>
    ...
    $.rbind = function (func, context) {
        return $.fbind.apply(null, ([func, context, true]).concat($.slice(arguments, 2)));
    };
